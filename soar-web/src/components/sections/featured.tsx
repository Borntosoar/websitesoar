    ...
    <section id="featured" ref={ref} className="grid bg-white text-black md:grid-cols-2">
      <div className="relative min-h-[62svh] overflow-hidden bg-black md:min-h-[90svh]">
        <motion.div style={{ y }} className="absolute inset-[-6%] grid place-items-center" >
          ...
          <span className="relative select-none font-semibold text-[26vw] leading-none text-white/[0.06] md:text-[14rem] tabular-nums">001</span>
        </motion.div>
        <span className="absolute bottom-6 left-6 text-[11px] uppercase tracking-[0.2em] text-white/40 tabular-nums">The Escape — Vol.01</span>
      </div>
      <div className="flex flex-col justify-center gap-5 px-6 py-16 md:px-16">
        <Reveal><span className="text-[11px] uppercase tracking-[0.3em] text-black/50 tabular-nums">Drop 001</span></Reveal>
