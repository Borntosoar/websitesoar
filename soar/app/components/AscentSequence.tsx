        ...
        <div>
          {PRINCIPLES.map((s, i) => (
            <Reveal key={s.n} delay={i * 0.04}>
              <div className="grid grid-cols-[auto_1fr] items-start gap-x-6 border-b border-line py-8 md:grid-cols-[5rem_1fr_minmax(0,34ch)] md:gap-x-10 md:py-12">
                <span className="mono pt-3 text-ash md:pt-5">{s.n}</span>
                <h3 className="display text-[clamp(2.1rem,6.5vw,5rem)]">{s.word}</h3>
