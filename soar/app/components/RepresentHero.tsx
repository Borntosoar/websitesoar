  ...
  return (
    <section id="top" className="on-dark relative h-[82svh] w-full overflow-hidden bg-[#0b0a09] text-paper md:h-svh">
      ...
      <div className="absolute inset-x-0 bottom-0 flex flex-col items-center px-6 pb-[9svh] text-center">
        <p className="mono hero-rise text-paper/70">Collection One — Drop 001</p>
        ...
        <a
          href="#collection"
          className="mono hero-rise mt-7 border border-paper/50 bg-black/25 px-12 py-3.5 text-paper backdrop-blur-sm transition-colors hover:bg-paper hover:text-ink"
